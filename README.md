# Dunkirk — Battle of the Skies

A retro arcade-style 2D shoot ’em up built with Godot, inspired by World War II aviation combat.  
The game places the player in the cockpit of an elite pilot squadron tasked with achieving air superiority through fast-paced dogfights and escalating aerial threats.
...
## Link for Gameplay
- Beta Test Video: https://youtu.be/rWm5cBLhl1o  
- Beta Test: https://jazzy-stardust-ed12e1.netlify.app/dunkirk.html  
- Final Test Video: https://youtu.be/0ezLpZDt4x4
- Final Test: https://cheery-sable-f2dce2.netlify.app/dunkirk.html
...
- Bright, readable sprites designed for fast gameplay

### Art Style
- WWII aviation–inspired aircraft designs
- Stylized exaggeration of colors and effects for arcade clarity
- 2D top-down shooter perspective

### Mood
- Intense combat-focused gameplay
- Nostalgic arcade atmosphere
- Fast-paced and skill-driven action
...
## Target Audience
- Fans of classic arcade shooters
- Players interested in WWII or aviation themes
- Enthusiasts of retro pixel-style games
...
### Visual & Environment Assets
- Free Sky with Clouds Background Pixel Art Set  
  https://free-game-assets.itch.io/free-sky-with-clouds-background-pixel-art-set

- Free Pixel Art Cloud and Sky Backgrounds  
  https://free-game-assets.itch.io/free-pixel-art-cloud-and-sky-backgrounds

- Pixel Planes Assets Pack  
  https://clavs.itch.io/pixel-planes-assets-pack

- Map Asset (Selidovo)  
  https://firefight-map-nyb.itch.io/mapselidovo

### Tutorials & Learning Resources
- Godot 2D Shooter Tutorial  
  https://www.youtube.com/watch?v=m8dJ6ssLkc8

### Sound Effects (SFX)
- Heavy Machine Gun (.50 Cal)  
  https://pixabay.com/sound-effects/film-special-effects-066496-heavy-machine-gun-50-caliber-28243/

- Retro Explosion 1  
  https://pixabay.com/sound-effects/film-special-effects-retro-explode-1-236678/

- Retro Explosion 2  
  https://pixabay.com/sound-effects/film-special-effects-retro-explode-2-236688/

- Prop Plane Engine Sound  
  https://pixabay.com/sound-effects/city-prop-plane-14513/

- Meaty Gunshot  
  https://pixabay.com/sound-effects/film-special-effects-meaty-gunshot-101257/

### Background Music
- Retro Arcade / Shooter Background Music  
  https://www.youtube.com/watch?v=VEwht-yY5Yg&list=RDVEwht-yY5Yg&start_radio=1
...
## Bug Fixes and Improvements (From Beta Form Feedback)

Based on player feedback from the beta form, the following issues were addressed:

- **Pause button input error (ESC key):**
  Fixed pause/input handling so pressing the assigned pause key works correctly and consistently.

- **Score clarity issue:**
  Improved score visibility and reliability during gameplay so players can clearly track progress.

- **Lack of tutorial / unclear controls:**
  Added clearer onboarding guidance for how to move, shoot, pause, and play the core loop.

- **Player movement not responding:**
  Fixed airplane movement input detection to ensure the plane can be controlled properly.

- **Left/right movement felt too slow:**
  Adjusted horizontal movement speed/responsiveness for smoother control and better gameplay feel.
